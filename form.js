...
document.getElementById("submit-form").addEventListener("click", function ()  {
    ...
    progressSteps.forEach(async(progressStep, idx) => {
    if (idx <= formStepsNum) {
      ...
      const  submissionLink = document.getElementById("ID").value
      const abstract = document.getElementById("Abstract").value

      // console.log({name,email,regno,id,abstract})

      const response = await axios.post("https://ieiadmin.herokuapp.com/data" , {name,email,regno, submissionLink,abstract});
